...
This VM has been completely customized with the intention of using it in a CTF competition. It makes use of 32-bit opcodes and registers. It comes with unique versions for jump instructions and a finite quantity of flags.
...
It is being used here to perform bit manipulation
#### Control Flow
